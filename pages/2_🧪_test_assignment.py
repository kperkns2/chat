...
str_prompt = "You give the user a list of options. They pick one, although they don't have to type it exactly. You repeat their choice exactly as it appears in the list. Return the answer inside 3 square brackets such as [[[answer]]] If they don't pick then politely encourage them to pick one"
